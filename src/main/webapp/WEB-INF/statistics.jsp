<%@ page import="com.javarush.kazakov.entity.user.Role" %>
...
<%
    Object usersObj = session.getAttribute(Attr.USERS);
    Map<UserTo, Integer> users = null;
    if (usersObj != null) {
        users = (Map<UserTo, Integer>) usersObj;
    }
    for (Map.Entry<UserTo, Integer> entry : users.entrySet()) {
%>
<div class="container" style="border-bottom: 1px solid var(--bs-gray);">
    <div class="row row-cols-5">
        <div class="col d-flex flex-column justify-content-center align-items-center">
            ...
            <%}%>
            <img class="rounded-circle" src="images/<%=entry.getKey().image()%>" alt="/images/no-image.png" width="48" height="48">
            <h4 class="fw-bold mb-0"><%=entry.getKey().login()%>
            </h4>
            <p class="mb-0">User</p>
        </div>
        <div class="col d-flex flex-column justify-content-center align-items-center">
            ...
            <h4 class="fw-bold mb-0"><%=entry.getKey().victory()%>
            </h4>
        ...
        <div class="col d-flex flex-column justify-content-center align-items-center">
            ...
            <h4 class="fw-bold mb-0"><%=entry.getKey().defeat()%>
            </h4>
        ...
        <div class="col d-flex flex-column justify-content-center align-items-center">
            ...
            <h4 class="fw-bold mb-0"><%=(entry.getKey().victory() + entry.getKey().defeat())%>
            </h4>
        ...
        <div class="col d-flex flex-column justify-content-center align-items-center">
            ...
            <h4 class="fw-bold mb-0"><%=entry.getValue()%></h4>
