...
<%}%>
<footer class="text-center text-light text-bg-dark py-4 mt-auto" style="border-top: 3px solid var(--bs-gray) ;">
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-3">
            <div class="col">
                <p class="text-muted my-2">Copyright&nbsp;© 2025 JavaRush</p>
            </div>
            <div class="col">
                    ...
                    <li class="list-inline-item me-4">
                        <div class="bs-icon-circle bs-icon-primary bs-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                 viewBox="0 0 16 16" class="bi bi-github">
